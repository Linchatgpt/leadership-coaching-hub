...
「卓越領導力©核心課程」的 Leadership Coaching Hub 對外呈現 Module 01–05；內部仍以原 Chapter07–11 檔名維持連結與紀錄相容性。五個主題聚焦教練成功條件、教練能力、教練流程、失控修復與持續精熟。
...
- `LPI_Coach_Chapter07.html` through `LPI_Coach_Chapter11.html` are this project's canonical module outputs.
